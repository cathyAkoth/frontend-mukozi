        ...
        >
          {
            <FormStep
              ...
              validationSchema={yup.object({
                ...
                passport: yup.boolean().required(), //.oneOf([true, false])
              })}
            >
          ...
          <FormStep
            ...
            validationSchema={yup.object({
              ...
              // .required("Select prefered job location(s)"),
            })}
          >
            <header
              className="form-header"
            ...
            <Grid container spacing={3}>
              <Grid item sm={6}>
                ...
                />
                {/* <Controls.DatePicker name="hireDate" label="Hire Date" /> */}
              </Grid>
              <Grid item sm={6}>
                {/* <FormControls.Select
                name="age"
          ...
          <FormStep
            ...
            validationSchema={yup.object({
              description: yup
                .string()
                .min(80, "Description too short...Atleast 80 characters")
                .max(180, "Too Long!")
                .matches(
                  /^[aA-zZ\s]+$/,
